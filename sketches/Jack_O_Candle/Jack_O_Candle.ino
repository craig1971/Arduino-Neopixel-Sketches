...
// SOURCE: https://github.com/schnoggo/jack-o-candle/blob/master/jack-o-candle.ino

/*
 Flames
The code simulates "flames," each made of 3 NeoPixels. This allows us to use more resolution in the colors. 
Instead of each color channel having 256 possibled values, it has 768.
...
To create a flicker effect, every time we decrease the brightness of a flame,
we introduce a chance to reverse direction and start increasing brighness again.
...
GetMaxBrightness() has some alternative models commented out. 
If you want your flame "height" to be more uniform, try those models. 
 */
...
#define NUMBER_OF_FLAMES 6 // depends on number of neopixel triplets. 5 for 16 NeoPixel ring. 4 for 12 NeoPixel ring
#define FLAME_WIDTH 6      // How wide are the flames (in LEDs)
#define FLICKER_CHANCE 10   // increase this to increase the chances an individual flame will flicker
